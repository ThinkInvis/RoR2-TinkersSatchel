...
Installation of NavYoink is also required: https://thunderstore.io/package/ThinkInvis/NavYoink/

## Building

Building Tinker's Satchel locally will expect NavYoink to be built in parallel solution folders. If this is not the case, you will need to specify the reference path to these DLLs manually.
