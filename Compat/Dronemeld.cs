...
namespace ThinkInvisible.TinkersSatchel {
    ...
    ///</summary>
    internal static class Compat_Dronemeld {
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.NoOptimization)]
        internal static int SafeGetStackCount(Inventory inv) {
            if(!enabled) return 0;
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.NoOptimization)]
        internal static CharacterMaster TryApply(CharacterMaster ownerMaster, string targetPrefabName) {
