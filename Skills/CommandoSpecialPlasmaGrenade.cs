...
namespace ThinkInvisible.TinkersSatchel {
	public class CommandoSpecialPlasmaGrenade : T2Module<CommandoSpecialPlasmaGrenade> {
		...
		public override void RefreshPermanentLanguage() {
			...
			permanentGenericLanguageTokens.Add("TKSAT_COMMANDO_SPECIAL_PLASMAGRENADE_DESCRIPTION", "<style=cIsDamage>Ignite</style>. Throw a grenade that homes to characters and sticks to anything, then explodes for <style=cIsDamage>500% damage</style> to enemies. Can hold up to 2. Watch your aim near low walls.");
