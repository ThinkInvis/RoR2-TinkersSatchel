...
namespace ThinkInvisible.TinkersSatchel {
    public class VoidwispHive : Item<VoidwispHive> {
        ...
        [AutoConfig("Lifetime of Voidwisp Hive wisps.", AutoConfigFlags.DeferForever, 0f, float.MaxValue)]
        public float wispDuration { get; private set; } = 10f;

        [AutoConfigRoOSlider("{0:P1}", 0f, 10f)]
        [AutoConfigUpdateActions(AutoConfigUpdateActionTypes.InvalidateLanguage | AutoConfigUpdateActionTypes.InvalidateStats)]
        [AutoConfig("Damage fraction dealt by Voidwisp attacks per stack.", AutoConfigFlags.None, 0f, float.MaxValue)]
        public float damageAmt { get; private set; } = 0.08f;

        [AutoConfigRoOSlider("{0:N2} s", 0f, 10f)]
        [AutoConfigUpdateActions(AutoConfigUpdateActionTypes.InvalidateLanguage | AutoConfigUpdateActionTypes.InvalidateStats)]
        [AutoConfig("Time, in seconds, between attacks.", AutoConfigFlags.None, 0f, float.MaxValue)]
