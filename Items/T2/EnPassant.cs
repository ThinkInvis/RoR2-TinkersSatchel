...
namespace ThinkInvisible.TinkersSatchel {
    public class EnPassant : Item<EnPassant> {
        ...
        [AutoConfig("Base damage of the attack, per stack.", AutoConfigFlags.None, 0f, float.MaxValue)]
        public float attackDamage { get; private set; } = 0.7f;

        [AutoConfigRoOSlider("{0:N0} s", 0f, 10f)]
        [AutoConfigUpdateActions(AutoConfigUpdateActionTypes.InvalidateLanguage)]
        [AutoConfig("Duration of the attack.", AutoConfigFlags.None, 0f, float.MaxValue)]
