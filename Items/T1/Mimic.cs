...
namespace ThinkInvisible.TinkersSatchel {
    public class Mimic : Item<Mimic> {
        ...
        protected override string GetDescString(string langid = null) => $"Picks one of your other items to <style=cIsUtility>mimic</style> <style=cStack>(each stack is tracked separately)</style>. <style=cIsUtility>Every {scrambleRate:N0} seconds</style>, all mimics will <style=cIsUtility>scramble</style> to a small, randomly-selected fraction of your item types.";
