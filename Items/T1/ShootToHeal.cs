...
namespace ThinkInvisible.TinkersSatchel {
    public class ShootToHeal : Item<ShootToHeal> {
        ...
        public ShootToHeal() {
            ...
            iconResource = TinkersSatchelPlugin.resources.LoadAsset<Sprite>("Assets/TinkersSatchel/Textures/UnlockIcons/shootToHealIcon.png");
        }
    ...
    public class TkSatShootToHealAchievement : RoR2.Achievements.BaseAchievement, IModdedUnlockableDataProvider {
        ...
        public Sprite Sprite => TinkersSatchelPlugin.resources.LoadAsset<Sprite>("Assets/TinkersSatchel/Textures/ItemIcons/shootToHealIcon.png");
