...
namespace ThinkInvisible.TinkersSatchel {
	public class Headset : Item<Headset> {
		...
		protected override string[] GetDescStringArgs(string langID = null) => new[] {
			procCount.ToString("N0"), stackProcCount.ToString("N0"), baseDamagePct.ToString("0%"), stackDamagePct.ToString("0%"), stunDuration.ToString("N1")
		};
		...
		public override void SetupModifyItemDef() {
			...
			displayRules.Add("RailgunnerBody", new ItemDisplayRule {
				...
				followerPrefab = idrPrefab,
				childName = "Hood1",
				localPos = new Vector3(-0.01385F, -0.02739F, -0.09348F),
				localAngles = new Vector3(352.0245F, 119.2666F, 137.1029F),
				localScale = new Vector3(0.4F, 0.4F, 0.4F)
			});
			displayRules.Add("VoidSurvivorBody", new ItemDisplayRule {
				...
				followerPrefab = idrPrefab,
				childName = "Head",
				localPos = new Vector3(0.02405F, 0.01485F, 0.00749F),
				localAngles = new Vector3(334.2645F, 28.96341F, 328.2314F),
